...
void GPUDblReggeMod_exec(dim3 dimGrid, dim3 dimBlock, GPU_AMP_PROTO, GDouble S0, GDouble b_par, GDouble c0, GDouble c1, GDouble c2, GDouble n0, GDouble n1, GDouble n2, GDouble a0, GDouble a1,GDouble a2, GDouble a3, GDouble a4, int fastParticle, int charge );
...
public:
        ...
        enum UserVars {u_s12=0,u_s23=1,u_t1=2,u_t2=3,u_s=4,u_u3=5,u_beamM2=6, u_p1M2=7, u_p2M2=8, u_recoilM2=9,u_up1=10, u_up2=11, u_phi=12,kNumUserVars };
	...
	complex< GDouble > calcAmplitude( GDouble** pKin, GDouble* userVars ) const;
        ...
        std::complex<double> ampEtaPi0(double par[7], int hel[3],  double inv[6], double mass2[4]) const;
...
private:
	...
	int charge; // 0 for neutral, 1 for charged
        AmpParameter c0,c1,c2,n0,n1,n2,b_par,a0,a2,a1,a3,a4;
        AmpParameter S0;
};
